...
from diff_utils import get_llava_format_data_with_diff
from utils import train_data_filter
...
if __name__ == "__main__":
    ...
    train_split_data = get_llava_format_data_with_diff(args.dir_path, task_dict["train"], args.trial_num,
                                                       args.sample_rate, args.image_num, args.action_his_num,
                                                       args.use_cot)
    ...
    if args.save_eval_data:
        valid_split_data = get_llava_format_data_with_diff(args.dir_path, task_dict["valid"], 1, 1, args.image_num,
                                                           args.action_his_num, args.use_cot)
        test_split_data = get_llava_format_data_with_diff(args.dir_path, task_dict["test"], 1, 1, args.image_num,
                                                          args.action_his_num, args.use_cot)
