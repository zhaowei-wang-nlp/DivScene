...
from utils import get_llava_format_data, train_data_filter
...
if __name__ == "__main__":
    ...
    train_split_data = get_llava_format_data(args.dir_path, task_dict["train"], args.trial_num,
    ...
    if args.save_eval_data:
        valid_split_data = get_llava_format_data(args.dir_path, task_dict["valid"], 1, 1, args.image_num,
                                                 args.action_his_num, args.use_cot)
        test_split_data = get_llava_format_data(args.dir_path, task_dict["test"], 1, 1, args.image_num,
                                                args.action_his_num, args.use_cot)
