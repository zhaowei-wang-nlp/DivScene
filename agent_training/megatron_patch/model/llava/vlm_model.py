    ...
    def __init__(self,
        ...
        if self.pre_process:
            ...
            if self.args.vision_tower.endswith('clip-vit-large-patch14-336'):
                ...
                self.mm_projector = build_vision_projector_megatron(config, self.vision_tower.vision_config)
                ...
                self.mm_projector = build_vision_projector_megatron(config, self.vision_tower.config)
