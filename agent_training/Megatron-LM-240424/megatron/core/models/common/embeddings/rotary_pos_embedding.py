...
def apply_rotary_pos_emb_bshd(t: Tensor, freqs: Tensor, rotary_interleaved: bool = False) -> Tensor:
    ...
    #     print ('cos', cos_.shape, 'sin', sin_.shape, 't', t.shape, 't_pass', t_pass.shape)
    #     print ('cos', cos_[200:205, 0, 0, 60:68], 'sin', sin_[200:205, 0, 0, 60:68], )
    #     print ('t', t[200:205, 0, 0, 60:68])
