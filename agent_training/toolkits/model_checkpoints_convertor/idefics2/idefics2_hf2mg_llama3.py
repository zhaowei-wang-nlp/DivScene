...
def convert_checkpoint_from_transformers_to_megatron(args):
    ...
    idefics2_model =  Idefics2ForConditionalGeneration.from_pretrained('your_path/models/idefics2-8b')

    config = AutoConfig.from_pretrained('your_path/models/idefics2-8b')
    #text_config = config.text_config
    text_config = LlamaConfig.from_pretrained(args.load_path)

    mm_projector_state_dict = torch.load('your_path/models/idefics2-8b/mm_projector_7B_to_70B.pth', map_location="cpu")
