...
SOURCE_CKPT_PATH=/apdcephfs_sh2/share_300000800/user/xiaomanpan/llm-foundry/models/llama-3/hf/Meta-Llama-3-70B-Instruct
...
TARGET_CKPT_PATH=/apdcephfs_sh2/share_300000800/user/kaixinma/models/idefics2-llama3-70b-tp-${TP}-pp-${PP}
