...
MEGATRON_PATCH_PATH=/apdcephfs_us/share_300814644/user/tianqfang/kaixinma/Pai-Megatron-Patch
MEGATRON_PATH=${MEGATRON_PATCH_PATH}/Megatron-LM-240126
# SOURCE_CKPT_PATH=/apdcephfs_us/share_300814644/data/nlp/huggingface_models/idefics2-mistral-causal

SOURCE_CKPT_PATH=/apdcephfs_us/share_300814644/data/nlp/huggingface_models/idefics2-8b
...
TARGET_CKPT_PATH=/apdcephfs_us/share_300814644/data/nlp/megatron_models/idefics2-8b-instruct/idefics2-mistral-megatron-tp-${TP}-pp-${PP}
