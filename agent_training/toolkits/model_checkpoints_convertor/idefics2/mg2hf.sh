...
rsync -av --ignore-existing /apdcephfs_us/share_300814644/data/nlp/huggingface_models/idefics2-8b/* /apdcephfs_us/share_300814644/user/zhaoweiwang/hd_output/checkpoint/${MODEL_PATH}/${OUT_DIR}
...
OUT_DIR=hf_ckp
sh mg2hf_base_idefics_instruct.sh ${MODEL_PATH} ${IN_DIR} ${OUT_DIR}
rsync -av --ignore-existing /apdcephfs_us/share_300814644/data/nlp/huggingface_models/idefics2-8b/* /apdcephfs_us/share_300814644/data/nlp/pretrain_data/embodied_model/checkpoint/${MODEL_PATH}/${OUT_DIR}
