...
SOURCE_CKPT_PATH=/your_path/idefics2-8b-instruct/idefics2-mistral-megatron-tp-8-pp-1/release
...
TARGET_CKPT_PATH=/your_path/huggingface_models/mg-idefics2-8b
