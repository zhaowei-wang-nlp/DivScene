...
MEGATRON_PATCH_PATH=/apdcephfs_us/share_300814644/user/zhaoweiwang/Pai-Megatron-Patch
...
SOURCE_CKPT_PATH=/apdcephfs_us/share_300814644/data/nlp/pretrain_data/embodied_model/checkpoint/${MODEL_PATH}/${2}
CONFIG_PATH=/apdcephfs_us/share_300814644/data/nlp/huggingface_models/idefics2-8b
...
TARGET_CKPT_PATH=/apdcephfs_us/share_300814644/data/nlp/pretrain_data/embodied_model/checkpoint/${MODEL_PATH}/${3}
