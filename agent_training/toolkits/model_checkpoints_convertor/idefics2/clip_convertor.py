...
def convert_checkpoint_from_transformers_to_megatron(args):
    ...
    vision_tower_path = "your_path/huggingface_models/idefics2-vision-model/vision_model.pth"
...
def convert_checkpoint_from_megatron_to_transformers(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        'your_path/huggingface_models/meta-llama/Meta-Llama-3-8B-Instruct-tp8-pp1/',
    ...
    vision_config = CLIPVisionConfig.from_pretrained('your_path/huggingface_models/openai/clip-vit-large-patch14-336/')
