...
def bulk_move():
    ...
    dest_base_folder = '/apdcephfs_us/share_300814644/data/nlp/pretrain_data/LLaVA-Pretrain/pretrain_images/'
...
def prepare_webdataset_pretrain():
    ...
    # with open('/apdcephfs_us/share_300814644/data/nlp/pretrain_data/LLaVA-Pretrain/blip_laion_cc_sbu_558k_seed42.json', 'w') as fout:
    ...
    for start in range(0, len(id_count), 83000):
        ...
        shard += 1
    with open('/apdcephfs_us/share_300814644/data/nlp/pretrain_data/LLaVA-Pretrain/shardlist.json', 'w') as fout:
...
def prepare_webdataset():
    ...
    with open('/apdcephfs_us/share_300814644/data/nlp/pretrain_data/LLaVA-Instruct-150K/llava_v1_5_mix665k_seed42.json', 'w') as fout:
        json.dump(seed42_data, fout)
    exit()
    print (len(instruction_data))
    print (instruction_data[500000])
    ...
    for start in range(0, len(id_count), 83000):
        ...
        shard += 1
    with open('/apdcephfs_us/share_300814644/data/nlp/pretrain_data/LLaVA-Instruct-150K/llava_v1_5_data/shardlist.json', 'w') as fout:
        json.dump(shardlist, fout, indent=4)
...
def convert_mantis_webdataset():
    ...
    # with open('/apdcephfs_us/share_300814644/data/nlp/pretrain_data/mantis/shardlist.json', 'w') as fout:
    #     json.dump(shardlist, fout, indent=4)
    # exit()
    ...
    #exit()
    # with open('/apdcephfs_us/share_300814644/data/nlp/pretrain_data/mantis/merged_data.json', 'w') as fout:
